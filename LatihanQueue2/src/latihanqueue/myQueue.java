...
class myQueue {
    ...
    void tampilKumpulanNasabah(){
        Nasabah a;
        for (int i = 0; i < kumpulanNasabah.size(); i++) {
            a = kumpulanNasabah.get(i);
            System.out.println("No : "+a.getNomorAntrian()+" Nama : "+a.getNama()+" Umur : "+a.getUmur());
